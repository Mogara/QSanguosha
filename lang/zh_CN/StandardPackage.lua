...
★若对方只有一张【闪】或【杀】则即便使用（打出）了也无效", 
	...
	["@guicai-card"] = "请使用【鬼才】技能来修改判定", 
	["@guidao-card"] = "请使用【鬼道】技能来修改判定", 
