...
-- olympics
	...
	["hanba"] = "旱魃",
	["fentian"] = "焚天",
	[":fentian"] = "<b>锁定技</b>，回合结束阶段开始时，若你的手牌数小于体力值，你选择一名你攻击范围内的角色，将其一张牌置于你的武将牌上，称为“焚”。你的攻击范围+X（X为“焚”的数量）",
	["phone"] = "焚",
	["zhiri"] = "炙日",
	[":zhiri"] = "<b>觉醒技</b>，回合开始阶段开始时，若“焚”的数量达到3或更多，你减1点体力上限，然后获得技能“心惔”。（出牌阶段限一次，你可以将两张“焚”置于弃牌堆并令一名角色失去一点体力）",
	["#ZhiriWake"] = "%from 的“焚”的数量达到 %arg 个，触发觉醒技【%arg2】",
	["xintan"] = "心惔",
	[":xintan"] = "出牌阶段限一次，你可以将两张“焚”置于弃牌堆并令一名角色失去一点体力。",
}
