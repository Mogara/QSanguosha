...
武器特效：1、你的回合外，你每受到一次伤害，在其结算完后你可以立即使用一张【杀】。2、当此剑从装备区失去时，你可用此剑指定一名其他角色受到你造成的1点无属性伤害",
	...
	["caochong"] = "曹冲",
	["chengxiang"] = "称象",
	[":chengxiang"] = "每当你受到1次伤害后，你可以弃置X张点数之和与造成伤害的牌的点数相等的牌，你选择X名角色，若其已受伤则恢复1点体力，否则摸两张牌。",
	["@chengxiang-card"] = "请打出点数之和为 %arg 的卡牌以发动【称象】技能",
	["~chengxiang-card"] = "选择若干张牌→选择若干名角色→点击确定",
	["conghui"] = "聪慧",
	...
	["zhangjunyi"] = "张儁乂",
	["jueji"] = "绝汲",
	[":jueji"] = "出牌阶段，你可以和一名角色拼点：若你赢，你获得对方的拼点牌，并可再次与其拼点，直到你没赢或不愿意继续拼点为止。每阶段限一次。",
	...
	["shaoying"] = "烧营",
	[":shaoying"] = "当你对一名不处于连环状态的角色造成一次火焰伤害在扣减体力前，你可选择一名其距离为1的另外一名角色，在该伤害结算完毕后，你进行一次判定：若判定结果为红色，你对选择的角色造成1点火焰伤害。",
	["zonghuo"] = "纵火",
	[":zonghuo"] = "<b>锁定技</b>，你的【杀】视为火【杀】结算。",
