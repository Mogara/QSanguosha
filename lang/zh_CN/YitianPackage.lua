...
◆弃牌阶段，若仅剩不可弃的手牌且超出手牌上限时，该角色需展示其手牌。例如，若指定的是装备牌，此时该角色2点体力，同时手里有两张【闪】和三张装备牌，弃牌阶段，该角色必须把两张【闪】弃掉，然后该角色展示这三张装备牌，结束他的回合", 
	...
	["luboyanf"] = "陆伯言(女)",
	["weiniang"] = "伪娘",
	[":weiniang"] = "锁定技，游戏开始时，你必须选择自己的性别。回合开始阶段，你必须倒转性别，异性角色对你造成的非雷电属性伤害无效。",
	["shaoying"] = "烧营",
	...
	["male"] = "男性",
	["female"] = "女性",
	["#WeiniangChoose"] = "%from 选择了 %arg 作为初始性别",
	["#WeiniangProtect"] = "%to 的【伪娘】锁定技被触发，异性(%from)的非雷电属性伤害无效",
	["#WeiniangFlip"] = "%from 的【伪娘】锁定技被触发，性别倒置",	
