...
return {
	...
	["ca0chong"] = "曹冲",
	["chengx1ang"] = "称象",
	[":chengx1ang"] = "每当你受到1次伤害，你可打出X张牌（X小于等于3），它们的点数之和与造成伤害的牌的点数相等，你可令X名角色各恢复1点体力（若其满体力则摸2张牌）。",
	...
	["luboyanf"] = "陆伯言(女)",
	["shenjun"] = "神君",
	[":shenjun"] = "<b>锁定技</b>，回合结束阶段开始时，你必须倒转性别，异性角色对你造成的非雷电属性伤害无效。\
★倒转性别，指的是男性变为女性，女性变为男性，没有第三种情况。",
	["shaoying"] = "烧营",
