...
return {
	...
	["cv:wangyi"] = "蒲小猫",
	["zhenlie"] = "贞烈",
	[":zhenlie"] = "当你成为一名其他角色使用的【杀】或非延时类锦囊的目标后，你可以失去1点体力，令此牌对你无效，然后你弃置该角色的一张牌。",
	["miji"] = "秘计",
	[":miji"] = "回合结束阶段开始时，若你已受伤，你可以摸至多X张牌，然后将等量的手牌交给其他角色。(X为你已损失的体力值。)",
	["miji:cancel"] = "不发动",
	["@miji"] = "因为【秘计】的后续效果，你须将 %dest 张牌交给一名其他角色",
	...
	["qianxi"] = "潜袭",
	[":qianxi"] = "回合开始阶段开始时，你可以进行一次判定，然后指定一名距离为1的角色，该角色不能使用或打出与判定牌颜色相同的手牌直到回合结束。",
...
◆醇是移出游戏的牌。",
	...
	["$zishou1"] = "退以自保，静观时变！", -- 123分别是摸123张牌的
	["$zishou2"] = "荆州沃土，自守足矣。",
	["$zishou3"] = "余粮甚厚，不急出兵。",
	["~liubiao"] = "不欲争天下，奈何……",
