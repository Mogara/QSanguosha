...
◆你跳过摸牌阶段可以什么都不做，也可以先选择第一名目标角色的一张手牌，将之置入处理区，再选择第二名目标角色的一张手牌，将之置入处理区，最后你从处理区获得这两张牌，视为获得目标角色的手牌。",
	["@qiaobian-judge"] = "您可以弃置一张手牌跳过判定阶段",
	["@qiaobian-draw"] = "您可以弃置一张手牌跳过摸牌阶段，获得其他至多两名角色各一张手牌",
	["@qiaobian-play"] = "您可以弃置一张手牌跳过出牌阶段，将一名角色装备区或判定区里的一张牌移动到另一名角色区域里的相应位置。",
	["@qiaobian-discard"] = "您可以弃置一张手牌跳过弃牌阶段",
	["~qiaobian1"] = "选择一手张牌——点击确定按钮",
	["~qiaobian2"] = "选择一手张牌——选择 0-2 名其他角色——点击确定按钮。若没有选择角色，视为直接跳过摸牌阶段",
	["~qiaobian3"] = "选择一手张牌——选择 0-1 名角色——点击确定按钮。若没有选择角色，视为直接跳过出牌阶段",
