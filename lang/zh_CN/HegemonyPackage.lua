...
return {
	...
	["tianfeng"] = "田丰",
	["sijian"] = "死谏",
	[":sijian"] = "每当你失去一次手牌后，若你的手牌数不大于X，你可以弃置一名其他角色的一张牌（X为你已损失的体力值）。",
	["suishi"] = "随势",
	[":suishi"] = "<b>锁定技</b>，每当一名其他角色扣减1点体力时，若其体力值小于X，你摸一张牌；当一名其他角色死亡时，你失去1点体力（X为你已损失的体力值且至少为1）。",
	...
	["zoushi"] = "邹氏",
	["huoshui"] = "祸水",
	[":qingcheng"] = "回合开始时，你可以弃置一张牌，获得一名其他存活角色的全部武将技能（主公技、限定技和觉醒技除外），直到你的下一个回合开始。",
	["@qingcheng"] = "请弃置一张牌",
	["~qingcheng"] = "选择一张手牌→选择一个目标→点“确定”",
	["qingchengcard"] = "倾城",
