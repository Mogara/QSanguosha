...
-- danchuang
	...
	["v5quanji"] = "權計",
	[":v5quanji"] = "其他角色的回合即将开始时，你可以与该角色进行一次拼点。若你赢，该角色跳过回合开始阶段及判定阶段。",
	["v5baijiang"] = "拜將",
	[":v5baijiang"] = "觉醒技，回合开始阶段若你的装备区的装备牌为三张或更多时，你必须增加1点体力上限，失去技能【权计】和【争功】并获得技能“野心”（见详解）。",
	["v5yexin"] = "野心",
	[":v5yexin"] = "你每造成或受到一次伤害，可将牌堆顶的一张牌放置在武将牌上，称为“权”。出牌阶段，你可以用任意数量的手牌与等量的“权”交换，每阶段限一次。",
	["v5zili"] = "自立",
	[":v5zili"] = "觉醒技，回合开始阶段，若你的“权”为四张或更多时，你必须减1点体力上限，并永久获得技能“排异”（回合结束阶段，将一张“权”移动到任何合理的区域，若不是你的区域，你可以摸一张牌）。",
	["v5paiyi"] = "排異",
	[":v5paiyi"] = "回合结束阶段，将一张“权”移动到任何合理的区域，若不是你的区域，你可以摸一张牌",

	["$v5zhenggong"] = "伐逆之任，何不予吾？ 
	["$v5quanji1"] = "（发动拼点）将军请留步
	["$v5quanji2"] = "（赢）将军劳苦功高，宜当暂歇
	["$v5quanji3"] = "（没赢）汝执意如此，莫要后悔
	["$v5baijiang"] = "请兵拜将，领军伐逆；破蜀之日，功成之时！
	["$v5yexin1"] = "（受到伤害）吾今功高，主必忌之！
	["$v5yexin2"] = "（交换牌）主畏吾谋，不可不寻后路！
	["$v5zili"] = "大权在握，功高振军；自立蜀中，以图天下！
	["$v5paiyi1"] = "（放进自己的区域）若不成，退居蜀中，亦可为王！
	["$v5paiyi2"] = "（放进其他人的区域并摸牌）若事成，会师洛阳，天下可定！
