...
-- danchuang
	...
	["v5baijiang"] = "拜將",
	[":v5baijiang"] = "<b>觉醒技</b>，回合开始阶段开始时，若你的装备区的装备牌为三张或更多时，你必须增加1点体力上限，失去技能【权计】和【争功】并获得技能“野心”（你每造成或受到一次伤害，可将牌堆顶的一张牌放置在武将牌上，称为“权”。出牌阶段，你可以用任意数量的手牌与等量的“权”交换，每阶段限一次）。",
	["#BaijiangWake"] = "%from 身上的装备达到 %arg 张，觉醒技【%arg2】触发",
	["v5yexin"] = "野心",
	[":v5yexin"] = "你每造成或受到一次伤害，可将牌堆顶的一张牌放置在武将牌上，称为“权”。出牌阶段，你可以用任意数量的手牌与等量的“权”交换，每阶段限一次。",
	["werpo"] = "權",
	["v5zili"] = "自立",
	[":v5zili"] = "<b>觉醒技</b>，回合开始阶段开始时，若你的“权”为四张或更多时，你必须减1点体力上限，并永久获得技能“排异”（回合结束阶段，将一张“权”移动到任何合理的区域，若不是你的区域，你可以摸一张牌）。",
