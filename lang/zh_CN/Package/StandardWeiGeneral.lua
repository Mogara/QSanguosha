...
return {
	...
	["xiahoudun"] = "夏侯惇",
	["ganglie"] = "刚烈",
	[":ganglie"] = "每当你受到伤害后，你可以进行判定，若结果不为红桃，来源选择一项：1.弃置两张手牌；2.受到你造成的1点伤害。",
	...
	["duanliang"] = "断粮",
	[":duanliang"] = "你可以将一张黑色基本牌或黑色装备牌当【兵粮寸断】使用；锁定技，你能对距离为2的角色使用【兵粮寸断】。",
	...
	["qiangxi"] = "强袭",
	[":qiangxi"] = "出牌阶段限一次，你可以失去1点体力或弃置一张武器牌，并选择你攻击范围内的一名其他角色，对该角色造成1点伤害。",

	["#xunyu"] = "王佐之才",
	["xunyu"] = "荀彧",
	["illustrator:xunyu"] = "LiuHeng",
	["quhu"] = "驱虎",
	[":quhu"] = "出牌阶段限一次，你可以与一名体力值大于你的角色拼点。若你赢，该角色对其攻击范围内你选择的另一名角色造成1点伤害。若你没赢，该角色对你造成1点伤害。",
