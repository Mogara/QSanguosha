...
return {
	...
	["jiangchi"] = "将驰",
	[":jiangchi"] = "摸牌阶段，你可以选择一项：1.额外摸一张牌，若如此做，你不能使用或打出【杀】，直到回合结束；2.少摸一张牌，若如此做，你于出牌阶段内使用【杀】无距离限制且能额外使用一张【杀】，直到回合结束。",
	...
	["zhenlie"] = "贞烈",
	[":zhenlie"] = "每当你成为一名其他角色使用的【杀】或非延时类锦囊牌的目标后，你可以失去1点体力，令此次对你结算的此牌对你无效，然后你弃置其一张牌。",
	["miji"] = "秘计",
	...
	["lihuo"] = "疠火",
	[":lihuo"] = "你可以将一张普通【杀】当火【杀】使用，或将你视为使用一张【杀】当你视为使用一张火【杀】，当此【杀】结算结束后，若此【杀】造成过伤害，你失去1点体力；<font color=\"blue\"><b>锁定技，</b></font>你使用火【杀】选择目标的个数上限+1。",
	["chunlao"] = "醇醪",
	...
	["anxu"] = "安恤",
	[":anxu"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以选择两名手牌数不相等的其他角色，令其中手牌少的角色先获得手牌多的角色的一张手牌再展示之，若此牌不为♠，你摸一张牌。",
	["zhuiyi"] = "追忆",
	...
	["gongqi"] = "弓骑",
	[":gongqi"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以弃置一张牌，令你于此回合内攻击范围无限，然后若你以此法弃置的牌为装备牌，你可以弃置一名其他角色的一张牌。",
	["@gongqi-discard"] = "你可以弃置一名其他角色的一张牌",
	["jiefan"] = "解烦",
	[":jiefan"] = "<font color=\"red\"><b>限定技，</b></font>出牌阶段，你可以选择一名角色，令攻击范围内含有该角色的所有角色（该角色除外）各选择一项：1.弃置一张武器牌；2.令其摸一张牌。",
