...
return {
	...
	["tieqi"] = "铁骑",
	[":tieqi"] = "每当你使用【杀】指定一名目标角色后，你可以进行判定，若结果为红色，该角色不能使用【闪】响应此次对其结算的此【杀】。",
	...
	["niepan"] = "涅槃",
	[":niepan"] = "限定技，当你处于濒死状态时，你可以弃置你区域里的所有牌，然后将武将牌平置并重置副将的武将牌，摸三张牌，将体力值回复至3点。",
	...
	["fangquan"] = "放权",
	[":fangquan"] = "你可以跳过出牌阶段，若如此做，此回合结束时，你可以弃置一张手牌并选择一名其他角色，若如此做，该角色获得一个额外的回合。",
