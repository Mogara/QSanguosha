...
local t = {
	...
	["heg_nullification:single"] = "无懈该角色",
	["heg_nullification:all"] = "无懈该势力" ,
	
	["indulgence"] = "乐不思蜀",
	[":indulgence"] = "延时锦囊牌\n\n使用时机：出牌阶段。\n使用目标：一名其他角色。\n作用效果：目标角色判定，若结果不为红桃，其跳过出牌阶段。",

	["lightning"] = "闪电",
	[":lightning"] = "延时锦囊牌\n\n使用时机：出牌阶段。\n使用目标：你。\n目标角色判定，若结果为黑桃2~9：其受到3点无来源的雷电伤害，将此【闪电】置入弃牌堆。",

	["iron_chain"] = "铁索连环",
	[":iron_chain"] = "锦囊牌\n\n使用时机：出牌阶段。\n使用目标：一至两名角色。\n每名目标角色选择一项：1.横置；2. 重置。\n◆此牌能重铸。",

	["fire_attack"] = "火攻",
	[":fire_attack"] = "锦囊牌\n\n使用时机：出牌阶段。\n使用目标：一名有手牌的角色。\n目标角色展示一张手牌，然后你可以弃置与之花色相同的一张手牌，若如此做，其受到你造成的1点火焰伤害。",
