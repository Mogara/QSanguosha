...
return {
	...
	["cunsi"] = "存嗣",
	[":cunsi"] = "出牌阶段，你可以移除此武将牌并选择一名角色，令该角色获得“勇决”（每当与你势力相同的一名角色使用的【杀】因结算完毕而置入弃牌堆时，若此【杀】为该角色于出牌阶段内使用的首张牌，其可以将此牌移动的目标区域改为其手牌），然后若该角色不为你，其摸两张牌。",
	["yongjue"] = "勇决",
	[":yongjue"] = "每当与你势力相同的一名角色使用的【杀】因结算完毕而置入弃牌堆时，若此【杀】为该角色于出牌阶段内使用的首张牌，其可以将此牌移动的目标区域改为其手牌。",
	...
	["hunshang"] = "魂殇",
	[":hunshang"] = "副将技，你计算体力上限时减少1个单独的阴阳鱼。准备阶段开始时，若你的体力值为1，视为你拥有技能“英姿”和“英魂”直到回合结束。",
	["yingzi_sunce"] = "英姿",
	["yinghun_sunce"] = "英魂",
	...
	["chuanxin"] = "穿心",
	[":chuanxin"] = "每当你于出牌阶段内使用【杀】或【决斗】对与你势力不同的目标角色造成伤害时，若该角色有副将，你可以防止此伤害，令其选择一项：" .. 
	...
	["wuxin"] = "悟心",
	[":wuxin"] = "摸牌阶段开始时，你可以观看牌堆顶的X张牌（X为群势力角色的数量），然后你可以改变这些牌的顺序。",
	["hongfa"] = "弘法",
	[":hongfa"] = "君主技，此武将牌明置时，你获得“黄巾天兵符”。" .. 
				  "准备阶段开始时，若“黄巾天兵符”上没有牌，则从牌堆顶亮出X张牌置于“黄巾天兵符”上，称为“天兵”（X为全场存活的群势力角色数）。\n\n" .. 
				  "“黄巾天兵符”\n" .. 
				  "你执行的效果中的“群势力角色的数量”+X（X为不大于“天兵”数量的自然数）；" .. 
				  "每当你失去体力时，你可以防止此失去体力，将一张“天兵”置入弃牌堆；" .. 
