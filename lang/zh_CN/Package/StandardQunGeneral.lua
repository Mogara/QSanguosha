...
return {
	...
	["huatuo"] = "华佗",
	["qingnang"] = "青囊",
	[":qingnang"] = "出牌阶段限一次，你可以弃置一张手牌并选择已受伤的一名角色，令其回复1点体力。",
	["jijiu"] = "急救",
	...
	["wushuang"] = "无双",
	[":wushuang"] = "锁定技，每当你使用【杀】指定一名角色为目标后，该角色需依次使用两张【闪】才能抵消此【杀】；" .. 
					"锁定技，每当你使用【决斗】指定一名角色为目标后，或成为一名角色使用【决斗】的目标后，该角色每次响应此【决斗】需依次打出两张【杀】。",
	...
	["lirang"] = "礼让",
	[":lirang"] = "每当你的一张牌因弃置而置入弃牌堆时，你可以将此牌移动的目标区域改为一名其他角色的手牌。",
