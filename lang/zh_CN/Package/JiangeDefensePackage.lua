...
return {
	...
	["jglingfeng"] = "灵锋",
	[":jglingfeng"] = "摸牌阶段开始时，你可以放弃摸牌，改为亮出牌堆顶的两张牌，然后获得之，若这些牌的颜色不同，你令一名敌方角色失去1点体力。",
	...
	["jgjingmiao"] = "精妙",
	[":jgjingmiao"] = "锁定技，每当敌方角色使用的【无懈可击】生效后，你令其失去1点体力。",
	...
	["jgjiguan_yazi"] = "机关",
	["jgdixian"] = "地陷",
	[":jgdixian"] = "结束阶段开始时，你可以将武将牌叠置，然后令所有敌方角色各弃置其装备区里的所有牌。",
