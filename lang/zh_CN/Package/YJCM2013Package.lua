...
return {
	...
	["jingce"] = "精策",
	[":jingce"] = "出牌阶段结束时，若你于此回合内使用过的牌的数量不小于你当前的体力值，你可以摸两张牌。",
	["jingce:draw"] = "摸一张牌",
	...
	["qiaoshui"] = "巧说",
	[":qiaoshui"] = "出牌阶段开始时，你可以与一名角色拼点。若你赢，你使用下一张基本牌或非延时类锦囊牌能额外（无距离限制）或少选择一个目标，直到回合结束。若你没赢，你不能使用锦囊牌，直到回合结束。",
	["qiaoshui:add"] = "增加一个目标",
	...
	["zhiyan"] = "直言",
	[":zhiyan"] = "结束阶段开始时，你可以令一名角色摸一张牌，然后展示之，若此牌为装备牌，该角色先回复1点体力再使用此牌。",
	...
	["qiuyuan"] = "求援",
	[":qiuyuan"] = "每当你成为【杀】的目标时，你可以令除此【杀】使用者外的一名有手牌的其他角色正面朝上将一张手牌交给你，若此牌不为【闪】，该角色也成为此【杀】的目标。",
	...
	["mieji"] = "灭计",
	[":mieji"] = "<font color=\"blue\"><b>锁定技，</b></font>你使用黑色非延时类锦囊牌选择目标的个数上限至少为2。",
