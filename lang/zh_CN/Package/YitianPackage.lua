...
武器特效：1、你的回合外，你每受到一次伤害，在其结算完后你可以立即使用一张【杀】。2、当此剑从装备区失去时，你可用此剑指定一名其他角色受到你造成的1点无属性伤害",
	...
	["conghui"] = "聪慧",
	[":conghui"] = "<font color=\"blue\"><b>锁定技，</b></font>跳过你的弃牌阶段。",
	["zaoyao"] = "早夭",
	[":zaoyao"] = "<font color=\"blue\"><b>锁定技，</b></font>回合结束阶段开始时，若你的手牌数大于13，你须弃置所有手牌并失去1点体力。",
	...
	["liqian"] = "离迁",
	[":liqian"] = "<font color=\"blue\"><b>锁定技，</b></font>当你处于连理状态时，势力与连理对象的势力相同；当你处于未连理状态时，势力为魏",
	["lianli-slash"] = "连理（杀）",
	["lianlislash"] = "连理（杀）",
	["lianli-jink"] = "连理(闪)",
	...
	["luboyanf"] = "陆伯言(女)",
	["shenjun"] = "神君",
	[":shenjun"] = "<font color=\"blue\"><b>锁定技，</b></font>游戏开始时，你选择自己的性别。回合开始阶段开始时，你须改变性别，你受到异性角色造成的非雷电属性伤害时，你防止之。",
	["shaoying"] = "烧营",
	...
	["dushi"] = "毒士",
	[":dushi"] = "<font color=\"blue\"><b>锁定技，</b></font>杀死你的角色获得技能“崩坏”。",
	["@collapse"] = "崩坏",
	["@dongcha"] = "请选择“洞察”的目标",
	...
	["guzhielai"] = "古之恶来",
	["sizhan"] = "死战",
	[":sizhan"] = "<font color=\"blue\"><b>锁定技，</b></font>每当你受到一次伤害时，防止此伤害并获得等同于伤害点数的“死战”标记；回合结束阶段开始时，你失去等同于你拥有的“死战”标记数的体力并弃所有的死战标记。",
	["shenli"] = "神力",
	[":shenli"] = "<font color=\"blue\"><b>锁定技，</b></font>出牌阶段，你使用【杀】造成的<font color='red'>第一次伤害</font>+X，X为当前死战标记数且最大为3",
	...
	["yitianjian"] = "倚天剑",
	["zhengfeng"] = "争锋",
	[":zhengfeng"] = "<font color=\"blue\"><b>锁定技，</b></font>当你的装备区没有武器时，你的攻击范围为X，X为你当前体力值。",
	["ytzhenwei"] = "镇威",
