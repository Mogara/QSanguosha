...
◆此【杀】若未造成伤害，你不可以再次发动【解烦】，但你可以使用手牌里的【桃】进行响应；此【杀】若造成伤害，且执行视为对其使用一张【桃】的效果后该角色依然处于濒死状态，你可以再次发动【解烦】或使用手牌里的【桃】进行响应。",
	...
	["cv:nos_wangyi"] = "蒲小猫",
	["noszhenlie"] = "贞烈",
	[":noszhenlie"] = "在你的判定牌生效前，你可以从牌堆顶亮出一张牌代替之。",
	["nosmiji"] = "秘计",
	[":nosmiji"] = "回合开始/结束阶段开始时，若你已受伤，你可以进行一次判定，若判定结果为黑色，你观看牌堆顶的X张牌（X为你已损失的体力值），然后将这些牌交给一名角色。\
◆你在回合开始阶段开始时和回合结束阶段开始时，都可以发动一次【秘计】。",
	["$noszhenlie"] = "老娘能改判定牌！",
	["$nosmiji1"] = "有此九奇，可逐羌敌。",
	["$nosmiji2"] = "屯兵逐超，得保冀城。", -- 分给自己
	["$nosmiji3"] = "救兵已到，乃解城围。", -- 分给他人
	["$nosmiji4"] = "暂与汝和，仇必后报！", -- 分给马超
	...
	["nosqianxi"] = "潜袭",
	[":nosqianxi"] = "每当你使用【杀】对距离为1的目标角色造成伤害时，你可以进行一次判定，若判定结果不为红桃，你防止此伤害，改为令其减1点体力上限。",
	["#Qianxi"] = "%to 背后中枪，秀了自己的上限（谁干的呢？）",
	["$nosqianxi1"] = "（拔剑声）",
	["$nosqianxi2"] = "我敢杀你！",                   -- 成功
	["$nosqianxi3"] = "竟然有防备？只能力战搏杀之！ ", -- 潜袭失败
	["~nos_madai"] = "未能完成丞相遗命，辱没了我马家的威名呀~",

	["#nos_guanxingzhangbao"] = "将门虎子",
	["nos_guanxingzhangbao"] = "原小关张",
	["designer:nos_guanxingzhangbao"] = "诺思冥羽",
	["illustrator:nos_guanxingzhangbao"] = "HOOO",
	["cv:nos_guanxingzhangbao"] = "喵小林，风叹息",
	["nosfuhun"] = "父魂",
	[":nosfuhun"] = "摸牌阶段开始时，你可以放弃摸牌，改为从牌堆顶亮出两张牌并获得之，若亮出的牌颜色不同，你获得技能“武圣”、“咆哮”，直到回合结束。",
	["$nosfuhun1"] = "吾父武名，声震海内！",
	["$nosfuhun2"] = "父魂佑我！",
	["$nosfuhun3"] = "父辈功勋，望尘莫及……",
