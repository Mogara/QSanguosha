...
★大雾不能防止失去体力", 
	...
	["shenzhaoyun"] = "神赵云",
	["juejing"] = "绝境",
	[":juejing"] = "锁定计，摸牌阶段，你摸牌的数量为你已损失的体力值+2；你的手牌上限始终+2。",
	["longhun"] = "龙魂",
	[":longhun"] = "你可以将同花色的X张牌按下列规则适用（或打出）：♥当【桃】，♦当火属性的【杀】，♣当【闪】，♠当【无懈可击】。（X为你的当前体力值且至少为1）",
	...
	["@bear"] = "忍",
	["#JilveWansha"] = "%from 的忍标记达到 %arg 个(大于4)，达到拜印的觉醒条件",
