...
return {
	...
	[":supply_shortage"] = "锦囊牌，延时，出牌阶段，对除你以外，与你距离为1以内的角色使用（横置于该角色的判定区内），若其判定的结果不为梅花，则跳过该角色的摸牌阶段。", 
	...
	["#SilverLion"] = "%from 的锁定技【白银狮子】被触发，将 %arg 点伤害减至 1 点。", 
	["#VineDamage"] = "%from 的锁定技【藤甲】被触发，受到的 %arg 点火焰伤害增加到 %arg2 点火焰伤害。", 
	["@fire-attack"] = "%src 展示的牌的花色为 %arg，请弃掉与其相同花色的牌。", 
	["#GudingBladeEffect"] = "%from 的锁定技【古锭刀】被触发，无手牌目标 %to 受到的伤害从 %arg 点增加到 %arg2 点。",	
	["#Drank"] = "%from 使用了【酒】，下一张【杀】将具有伤害 +1 的效果。",
	["#UnsetDrank"] = "%from 的【杀】结算完毕，【酒】效果消失。",
	["#UnsetDrankEndOfTurn"] = "%from 的回合结束，【酒】效果消失。",
}
