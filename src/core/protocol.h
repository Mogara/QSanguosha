...
namespace QSanProtocol
{
    ...
    enum CommandType
    {
        ...
        S_COMMAND_CHOOSE_GENERAL_1,
        S_COMMAND_CHOOSE_GENERAL_2,
    ...
    public:
        ...
        int m_localSerial;        
        inline QSanGeneralPacket(PacketType packetType = S_UNKOWN_PACKET, CommandType command = S_UNKOWN_COMMAND)
        {
            m_globalSerial++;
            m_localSerial = 0;
